-- management-functions.sql
-- Canonical source: database/schema.sql (pgschema-managed)
-- This file is applied by the bootstrap-context install.sh
-- Keep in sync with schema.sql to avoid overwriting fixes.
-- See nova-mind#171 for the domain-based workflow matching fix.
...
BEGIN
    ...
    FROM (
        ...
        -- Domain-based matching only (orchestrator_agent_id and workflow_steps.agent_id were dropped)
        -- See nova-mind#171 / 5b20b40
        SELECT
