...
This guide shows you how to integrate and use the Agent Workflow Language (AWL) in your nova-mind cognition system. AWL lets you orchestrate complex multi-agent processes using declarative YAML workflows.

## Prerequisites

Before you start, ensure you have:

- [ ] **nova-mind** (with the `cognition/` subsystem) installed and running
...
*For questions about this guide, contact the documentation team or file an issue in the [nova-mind](https://github.com/NOVA-Openclaw/nova-mind) repository.*