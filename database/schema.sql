...
--
-- Name: mutability_class_enum; Type: TYPE; Schema: -; Owner: -
--
...
--
-- Name: agent_model_denylists; Type: TABLE; Schema: -; Owner: -
--

CREATE TABLE IF NOT EXISTS agent_model_denylists (
    id SERIAL,
    agent_id integer NOT NULL,
    model varchar(100) NOT NULL,
    reason text NOT NULL,
    failure_details text,
    denied_at timestamptz DEFAULT now() NOT NULL,
    denied_by varchar(100) DEFAULT CURRENT_USER NOT NULL,
    workflow_context text,
    CONSTRAINT agent_model_denylists_pkey PRIMARY KEY (id),
    CONSTRAINT agent_model_denylists_agent_id_model_key UNIQUE (agent_id, model),
...
--
-- Name: idx_agent_model_denylists_agent; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_agent_model_denylists_agent ON agent_model_denylists (agent_id);

--
-- Name: idx_agent_model_denylists_model; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_agent_model_denylists_model ON agent_model_denylists (model);
...
--
-- Name: entity_credibility; Type: TABLE; Schema: -; Owner: -
--
...
CREATE TABLE IF NOT EXISTS entity_credibility (
    ...
    CONSTRAINT entity_credibility_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES entities (id) ON DELETE CASCADE,
...
--
-- Name: idx_entity_credibility_domain; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_credibility_domain ON entity_credibility (domain);

--
-- Name: idx_entity_credibility_entity; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_credibility_entity ON entity_credibility (entity_id);

--
-- Name: idx_entity_credibility_score; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_credibility_score ON entity_credibility (score) WHERE (score < (0.3)::double precision);
...
CREATE TABLE IF NOT EXISTS entity_facts (
    ...
    assertion_intent assertion_intent_enum DEFAULT 'asserted'::assertion_intent_enum NOT NULL,
    mutability_class mutability_class_enum DEFAULT 'slow_changing'::mutability_class_enum NOT NULL,
...
--
-- Name: idx_entity_facts_assertion_intent; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_facts_assertion_intent ON entity_facts (assertion_intent);
...
--
-- Name: idx_entity_facts_gradable; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_facts_gradable ON entity_facts (entity_id, key) WHERE assertion_intent IN ('asserted'::public.assertion_intent_enum, 'speculative'::public.assertion_intent_enum);
...
--
-- Name: idx_entity_facts_mutability; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_entity_facts_mutability ON entity_facts (mutability_class) WHERE (mutability_class = 'immutable'::public.mutability_class_enum);
...
CREATE TABLE IF NOT EXISTS entity_fact_sources (
    ...
    last_seen timestamptz DEFAULT now(),
    source_url text,
    reporting_distance real DEFAULT 1.0 NOT NULL,
    ...
    CONSTRAINT entity_fact_sources_source_session_id_fkey FOREIGN KEY (source_session_id) REFERENCES channel_sessions (id),
    CONSTRAINT entity_fact_sources_reporting_distance_check CHECK (reporting_distance > 0.0::double precision AND reporting_distance <= 1.0::double precision),
...
--
-- Name: idx_efs_source_session; Type: INDEX; Schema: -; Owner: -
--

CREATE INDEX IF NOT EXISTS idx_efs_source_session ON entity_fact_sources (source_session_id) WHERE (source_session_id IS NOT NULL);
...
COMMENT ON COLUMN events.environment IS 'Where the event took place: host, system, or environment context (e.g. ''nova-local'', ''blockhenge-sarsen-2'', ''external/world''). NULL = unspecified/legacy.';
...
COMMENT ON COLUMN events_archive.environment IS 'Where the event took place: host, system, or environment context. NULL = unspecified/legacy.';
...
CREATE TABLE IF NOT EXISTS social_interactions (
    ...
    CONSTRAINT social_interactions_kind_check CHECK (kind IN ('mention'::text, 'engagement_candidate'::text)),
...
--
-- Name: work_queue; Type: TABLE; Schema: -; Owner: -
--
...
CREATE INDEX IF NOT EXISTS idx_work_queue_pending ON work_queue (status) WHERE (status = 'pending'::text);
...
--
-- Name: get_strictest_mutability(integer, varchar); Type: FUNCTION; Schema: -; Owner: -
--
...
COMMENT ON FUNCTION get_strictest_mutability(integer, varchar) IS 'Returns the strictest mutability class present for a (entity_id, key) group. Ordering: immutable > slow_changing > stateful. Used by contradiction detection: if ANY row for this key is immutable, conflicting values are genuine contradictions regardless of other rows'' classes.';
...
--
-- Name: idx_tasks_watchdog_recovery_open; Type: INDEX; Schema: -; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS idx_tasks_watchdog_recovery_open ON tasks (title) WHERE ((title)::text ~~ '[watchdog-recovery]%'::text) AND ((status)::text IN (('pending'::character varying)::text, ('in_progress'::character varying)::text));
...
--
-- Name: v_current_stateful_facts; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: v_fact_grades; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW v_fact_grades AS
 SELECT ef.id AS fact_id,
    ef.entity_id,
    ef.key,
    ef.value,
    ef.assertion_intent,
    ...
    COALESCE(efs.verification_quality, 0.5::real) AS v_axis,
    COALESCE(ec_domain.score, ec_global.score, 0.5::real) AS s_axis,
    COALESCE(ec_domain.score, ec_global.score, 0.5::real) * efs.reporting_distance * COALESCE(efs.verification_quality, 0.5::real) AS composite_grade,
...
REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_bootstrap_context FROM nova;
...
--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM argus;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM argus;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM athena;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM athena;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM coder;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM coder;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM conductor;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM conductor;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM erato;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM erato;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM flint;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM flint;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM gem;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM gem;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM gidget;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM gidget;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM graybeard;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM hermes;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM hermes;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM iris;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM iris;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM marcie;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM marcie;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM newhart;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM newhart;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE agent_model_denylists FROM nova;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM "nova-staging";

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM openproject_user;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM quill;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM quill;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM scout;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM scout;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM scribe;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM scribe;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agent_model_denylists FROM ticker;

--
-- Name: agent_model_denylists; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE agent_model_denylists FROM ticker;
...
REVOKE SELECT ON TABLE agents FROM graybeard;
...
REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE agents FROM nova;
...
REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE comms_items FROM nova;

--
-- Name: comms_responses; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE comms_responses FROM nova;
...
--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM argus;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM athena;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM coder;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM conductor;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM erato;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE entity_credibility FROM erato;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM flint;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE entity_credibility FROM flint;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM gem;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM gidget;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM graybeard;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM hermes;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE entity_credibility FROM hermes;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM iris;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM marcie;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE entity_credibility FROM newhart;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM newhart;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM nova;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM "nova-staging";

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE SELECT ON TABLE entity_credibility FROM openproject_user;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM quill;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM scout;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM scribe;

--
-- Name: entity_credibility; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE entity_credibility FROM ticker;
...
--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM argus;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM athena;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM coder;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM conductor;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM erato;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM flint;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM gem;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM gidget;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM hermes;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM iris;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM marcie;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM newhart;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE extraction_failures FROM nova;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM quill;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM scout;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM scribe;

--
-- Name: extraction_failures; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE extraction_failures FROM ticker;
...
REVOKE DELETE ON TABLE journal_entries FROM argus;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM athena;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM coder;
...
REVOKE DELETE ON TABLE journal_entries FROM flint;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM gem;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM gidget;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM hermes;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM iris;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM marcie;
...
REVOKE DELETE ON TABLE journal_entries FROM quill;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM scout;

--
-- Name: journal_entries; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE ON TABLE journal_entries FROM scribe;
...
--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM argus;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM athena;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM coder;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM conductor;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM erato;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM flint;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM gem;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM gidget;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM hermes;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM iris;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM marcie;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM newhart;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, SELECT, UPDATE ON TABLE work_queue FROM nova;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM quill;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM scout;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM scribe;

--
-- Name: work_queue; Type: PRIVILEGE; Schema: privileges; Owner: -
--

REVOKE DELETE, INSERT, UPDATE ON TABLE work_queue FROM ticker;
...
--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO argus;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO athena;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO coder;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO conductor;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO gem;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO gidget;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO iris;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO marcie;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO quill;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO scout;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO scribe;

--
-- Name: get_strictest_mutability(p_entity_id integer, p_key character varying); Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT EXECUTE ON FUNCTION get_strictest_mutability(p_entity_id integer, p_key character varying) TO ticker;
...
GRANT USAGE ON SEQUENCE agent_actions_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agent_bootstrap_context_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agent_domains_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agent_jobs_id_seq TO cadence;
...
--
-- Name: agent_model_denylists_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE agent_model_denylists_id_seq TO cadence;

--
-- Name: agent_model_denylists_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE agent_model_denylists_id_seq TO nova;
...
GRANT USAGE ON SEQUENCE agent_modifications_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agent_spawns_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agent_turn_context_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE agents_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE ai_models_id_seq TO cadence;
...
--
-- Name: blockers_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE blockers_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE certificates_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE channel_sessions_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE channel_transcripts_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE comms_checks_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE comms_digests_id_seq TO cadence;
...
--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO argus;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO athena;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO cadence;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO coder;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO conductor;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO erato;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO flint;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO gem;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO gidget;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO hermes;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO iris;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO marcie;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO newhart;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO quill;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO scout;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO scribe;

--
-- Name: comms_items_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_items_id_seq TO ticker;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO argus;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO athena;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO cadence;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO coder;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO conductor;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO erato;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO flint;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO gem;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO gidget;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO hermes;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO iris;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO marcie;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO newhart;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO quill;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO scout;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO scribe;

--
-- Name: comms_responses_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE comms_responses_id_seq TO ticker;

--
-- Name: d100_roll_log_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE d100_roll_log_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE entities_id_seq TO cadence;
...
--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO argus;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO athena;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE entity_credibility_id_seq TO cadence;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO coder;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO conductor;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO gem;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO gidget;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO iris;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO marcie;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO nova;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO quill;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO scout;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO scribe;

--
-- Name: entity_credibility_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE entity_credibility_id_seq TO ticker;
...
GRANT USAGE ON SEQUENCE entity_fact_conflicts_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE entity_fact_sources_id_seq TO cadence;
...
GRANT SELECT ON SEQUENCE entity_fact_sources_id_seq TO "nova-staging";
...
GRANT USAGE ON SEQUENCE entity_facts_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE entity_relationships_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE events_archive_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE events_id_seq TO cadence;
...
--
-- Name: extraction_failures_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE extraction_failures_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE extraction_metrics_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE fact_change_log_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE gambling_entries_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE gambling_logs_id_seq TO cadence;
...
--
-- Name: income_sources_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE income_sources_id_seq TO cadence;

--
-- Name: income_transactions_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE income_transactions_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE job_messages_id_seq TO cadence;
...
GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO argus;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO athena;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE journal_entries_id_seq TO cadence;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO coder;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO flint;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO gem;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO gidget;
...
GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO hermes;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO iris;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO marcie;
...
GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO quill;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO scout;

--
-- Name: journal_entries_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT, USAGE ON SEQUENCE journal_entries_id_seq TO scribe;
...
GRANT USAGE ON SEQUENCE lessons_archive_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE lessons_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE media_consumed_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE media_queue_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE media_tags_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE memory_embeddings_archive_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE memory_embeddings_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE music_works_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE place_properties_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE places_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE preferences_id_seq TO cadence;
...
--
-- Name: proactive_outreach_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE proactive_outreach_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE project_tasks_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE projects_id_seq TO cadence;
...
--
-- Name: prompt_helper_config_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE prompt_helper_config_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE publications_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE ralph_sessions_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE self_awareness_triggers_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE shopping_history_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE shopping_preferences_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE shopping_wishlist_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE skills_id_seq TO cadence;
...
--
-- Name: social_interactions_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE social_interactions_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE tags_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE tasks_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE tools_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE unsolved_problems_id_seq TO cadence;
...
--
-- Name: user_domains_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE user_domains_id_seq TO cadence;

--
-- Name: user_insights_id_seq; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT USAGE ON SEQUENCE user_insights_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE vehicles_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE vocabulary_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE workflow_runs_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE workflow_steps_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE workflows_id_seq TO cadence;
...
GRANT USAGE ON SEQUENCE works_id_seq TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE agent_actions TO cadence;
...
GRANT SELECT ON TABLE agent_aliases TO cadence;

--
-- Name: agent_bootstrap_context; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE agent_bootstrap_context TO bootstrap_reader;

--
-- Name: agent_bootstrap_context; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT INSERT, SELECT, UPDATE ON TABLE agent_bootstrap_context TO cadence;
...
GRANT SELECT ON TABLE agent_domains TO cadence;

--
-- Name: agent_jobs; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE agent_jobs TO cadence;
...
GRANT INSERT, SELECT, UPDATE ON TABLE agent_modifications TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE agent_spawns TO cadence;
...
GRANT SELECT ON TABLE agent_system_config TO cadence;

--
-- Name: agent_turn_context; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE agent_turn_context TO cadence;
...
GRANT SELECT ON TABLE agents TO cadence;

--
-- Name: ai_models; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE ai_models TO cadence;

--
-- Name: blockers; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE blockers TO cadence;

--
-- Name: bootstrap_context_config; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE bootstrap_context_config TO cadence;

--
-- Name: certificates; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE certificates TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE channel_activity TO cadence;
...
GRANT SELECT ON TABLE channel_sessions TO cadence;

--
-- Name: channel_transcripts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE channel_transcripts TO cadence;

--
-- Name: comms_checks; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE comms_checks TO cadence;

--
-- Name: comms_digests; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE comms_digests TO cadence;

--
-- Name: comms_items; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE comms_items TO cadence;

--
-- Name: comms_items; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE comms_items TO hermes;

--
-- Name: comms_responses; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE comms_responses TO cadence;

--
-- Name: comms_responses; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, REFERENCES, SELECT, TRIGGER, TRUNCATE, UPDATE ON TABLE comms_responses TO hermes;

--
-- Name: comms_state; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE comms_state TO cadence;

--
-- Name: d100_roll_log; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE d100_roll_log TO cadence;

--
-- Name: entities; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entities TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entity_fact_conflicts TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entity_fact_sources TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entity_facts TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entity_facts_archive TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE entity_relationships TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE event_entities TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE event_places TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE event_projects TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE events TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE events_archive TO cadence;
...
GRANT SELECT ON TABLE extraction_failures TO cadence;

--
-- Name: extraction_metrics; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE extraction_metrics TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE fact_change_log TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE gambling_entries TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE gambling_logs TO cadence;
...
GRANT SELECT ON TABLE income_sources TO cadence;

--
-- Name: income_transactions; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE income_transactions TO cadence;

--
-- Name: job_messages; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE job_messages TO cadence;
...
GRANT INSERT, SELECT, UPDATE ON TABLE journal_entries TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE lessons TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE lessons_archive TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE media_consumed TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE media_queue TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE media_tags TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE memory_embeddings TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE memory_embeddings_archive TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE memory_type_priorities TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE motivation_d100 TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE music_works TO cadence;

--
-- Name: place_properties; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE place_properties TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE places TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE preferences TO cadence;
...
GRANT SELECT ON TABLE proactive_outreach TO cadence;

--
-- Name: project_entities; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE project_entities TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE project_tasks TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE projects TO cadence;
...
GRANT SELECT ON TABLE prompt_helper_config TO cadence;

--
-- Name: publications; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE publications TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE ralph_sessions TO cadence;
...
GRANT SELECT ON TABLE self_awareness_triggers TO cadence;

--
-- Name: shopping_history; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE shopping_history TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE shopping_preferences TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE shopping_wishlist TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE skills TO cadence;
...
GRANT SELECT ON TABLE social_interactions TO cadence;

--
-- Name: tags; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE tags TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE tasks TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE tools TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE unsolved_problems TO cadence;
...
GRANT SELECT ON TABLE user_domains TO cadence;

--
-- Name: user_insights; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE user_insights TO cadence;

--
-- Name: vehicles; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE vehicles TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE vocabulary TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE work_tags TO cadence;
...
GRANT SELECT ON TABLE workflow_runs TO cadence;

--
-- Name: workflow_steps; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE workflow_steps TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE workflows TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE works TO cadence;
...
GRANT SELECT ON TABLE delegation_knowledge TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_agent_spawn_stats TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_agents TO cadence;
...
--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO argus;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO athena;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO cadence;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO coder;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO conductor;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO gem;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO gidget;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO iris;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO marcie;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO quill;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO scout;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO scribe;

--
-- Name: v_current_stateful_facts; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_current_stateful_facts TO ticker;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_entity_facts TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_event_timeline TO cadence;
...
--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO argus;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO athena;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO cadence;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO coder;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO conductor;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO gem;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO gidget;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO iris;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO marcie;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO quill;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO scout;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO scribe;

--
-- Name: v_fact_grades; Type: PRIVILEGE; Schema: privileges; Owner: -
--

GRANT SELECT ON TABLE v_fact_grades TO ticker;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_gambling_summary TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_media_queue_pending TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_media_with_tags TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_metamours TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_pending_tasks TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_pending_test_failures TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_ralph_active TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_relationships TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_task_tree TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE v_users TO cadence;
...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE workflow_steps_detail TO cadence;
