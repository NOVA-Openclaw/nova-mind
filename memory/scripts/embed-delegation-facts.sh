...
echo ""
echo "Test with:"
echo "  python3 \$HOME/.openclaw/scripts/proactive-recall.py 'help me debug this code'"
echo "  python3 \$HOME/.openclaw/scripts/proactive-recall.py 'commit these changes'"
