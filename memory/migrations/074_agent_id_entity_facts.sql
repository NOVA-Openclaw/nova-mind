...
INSERT INTO entity_facts (entity_id, key, value, source, confidence)
VALUES
  (1, 'agent_id', 'agent:nova', 'system', 1.0),
  (256, 'agent_id', 'agent:newhart', 'system', 1.0),
  (388, 'agent_id', 'agent:graybeard', 'system', 1.0)
