...
echo ""
echo "Test with:"
echo "  echo '{\"content\": \"help me debug this code\"}' | python3 ~/.openclaw/scripts/proactive-recall.py"
echo "  echo 'commit these changes' | python3 ~/.openclaw/scripts/proactive-recall.py"
