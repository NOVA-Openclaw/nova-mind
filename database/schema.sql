...
\restrict d9a34hXuR1t5oCnOOU2IFdZwvUObUqDb1z1ZPpm74NFDDKqPF14jh4wjmeKXqqx
...
--
-- Name: audit_bootstrap_agents(); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.audit_bootstrap_agents() OWNER TO newhart;

--
-- Name: FUNCTION audit_bootstrap_agents(); Type: COMMENT; Schema: public; Owner: newhart
--
...
--
-- Name: audit_bootstrap_universal(); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.audit_bootstrap_universal() OWNER TO newhart;

--
-- Name: FUNCTION audit_bootstrap_universal(); Type: COMMENT; Schema: public; Owner: newhart
--
...
--
-- Name: delete_agent_context(text, text); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.delete_agent_context(p_agent_name text, p_file_key text) OWNER TO newhart;

--
-- Name: delete_universal_context(text); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.delete_universal_context(p_file_key text) OWNER TO newhart;
...
--
-- Name: enforce_agent_chat_function_use(); Type: FUNCTION; Schema: public; Owner: nova
--

CREATE FUNCTION public.enforce_agent_chat_function_use() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.enforce_agent_chat_function_use() OWNER TO nova;
...
--
-- Name: expire_old_chat(integer); Type: FUNCTION; Schema: public; Owner: nova
--

CREATE FUNCTION public.expire_old_chat(retention_days integer DEFAULT 90) RETURNS integer
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.expire_old_chat(retention_days integer) OWNER TO nova;
...
--
-- Name: get_bootstrap_config(); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.get_bootstrap_config() OWNER TO newhart;

--
-- Name: FUNCTION get_bootstrap_config(); Type: COMMENT; Schema: public; Owner: newhart
--
...
--
-- Name: list_all_context(); Type: FUNCTION; Schema: public; Owner: newhart
--
...
ALTER FUNCTION public.list_all_context() OWNER TO newhart;

--
-- Name: FUNCTION list_all_context(); Type: COMMENT; Schema: public; Owner: newhart
--
...
--
-- Name: send_agent_message(text, text, text[]); Type: FUNCTION; Schema: public; Owner: nova
--

CREATE FUNCTION public.send_agent_message(p_sender text, p_message text, p_recipients text[]) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_id        INTEGER;
...
ALTER FUNCTION public.send_agent_message(p_sender text, p_message text, p_recipients text[]) OWNER TO nova;
...
ALTER TABLE ONLY public.agent_bootstrap_context REPLICA IDENTITY FULL;
...
CREATE TABLE public.agent_chat (
    ...
    channel character varying(50) DEFAULT 'agent'::character varying,
...
--
-- Name: agent_turn_context; Type: TABLE; Schema: public; Owner: newhart
--
...
ALTER TABLE public.agent_turn_context OWNER TO newhart;

--
-- Name: agent_turn_context_id_seq; Type: SEQUENCE; Schema: public; Owner: newhart
--
...
ALTER SEQUENCE public.agent_turn_context_id_seq OWNER TO newhart;

--
-- Name: agent_turn_context_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: newhart
--
...
COMMENT ON TABLE public.agents IS 'Agent registry';
...
--
-- Name: ai_models_id_seq; Type: SEQUENCE; Schema: public; Owner: nova
--
...
ALTER SEQUENCE public.ai_models_id_seq OWNER TO nova;

--
-- Name: ai_models_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: nova
--
...
--
-- Name: events_archive_id_seq; Type: SEQUENCE; Schema: public; Owner: nova
--

CREATE SEQUENCE public.events_archive_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.events_archive_id_seq OWNER TO nova;

--
-- Name: events_archive_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: nova
--

ALTER SEQUENCE public.events_archive_id_seq OWNED BY public.events_archive.id;
...
--
-- Name: lessons_archive_id_seq; Type: SEQUENCE; Schema: public; Owner: nova
--

CREATE SEQUENCE public.lessons_archive_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.lessons_archive_id_seq OWNER TO nova;

--
-- Name: lessons_archive_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: nova
--

ALTER SEQUENCE public.lessons_archive_id_seq OWNED BY public.lessons_archive.id;
...
--
-- Name: memory_embeddings_archive_id_seq; Type: SEQUENCE; Schema: public; Owner: nova
--

CREATE SEQUENCE public.memory_embeddings_archive_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.memory_embeddings_archive_id_seq OWNER TO nova;

--
-- Name: memory_embeddings_archive_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: nova
--

ALTER SEQUENCE public.memory_embeddings_archive_id_seq OWNED BY public.memory_embeddings_archive.id;
...
--
-- Name: agent_turn_context id; Type: DEFAULT; Schema: public; Owner: newhart
--
...
--
-- Name: events_archive id; Type: DEFAULT; Schema: public; Owner: nova
--

ALTER TABLE ONLY public.events_archive ALTER COLUMN id SET DEFAULT nextval('public.events_archive_id_seq'::regclass);
...
--
-- Name: lessons_archive id; Type: DEFAULT; Schema: public; Owner: nova
--

ALTER TABLE ONLY public.lessons_archive ALTER COLUMN id SET DEFAULT nextval('public.lessons_archive_id_seq'::regclass);
...
--
-- Name: memory_embeddings_archive id; Type: DEFAULT; Schema: public; Owner: nova
--

ALTER TABLE ONLY public.memory_embeddings_archive ALTER COLUMN id SET DEFAULT nextval('public.memory_embeddings_archive_id_seq'::regclass);
...
--
-- Name: agent_turn_context agent_turn_context_context_type_file_key_key; Type: CONSTRAINT; Schema: public; Owner: newhart
--
...
--
-- Name: agent_turn_context agent_turn_context_pkey; Type: CONSTRAINT; Schema: public; Owner: newhart
--
...
--
-- Name: idx_agent_chat_recipients; Type: INDEX; Schema: public; Owner: nova
--

CREATE INDEX idx_agent_chat_recipients ON public.agent_chat USING gin (recipients);
...
CREATE INDEX idx_agent_chat_sender ON public.agent_chat USING btree (sender, "timestamp" DESC);


--
-- Name: idx_agent_chat_timestamp; Type: INDEX; Schema: public; Owner: nova
--

CREATE INDEX idx_agent_chat_timestamp ON public.agent_chat USING btree ("timestamp");
...
--
-- Name: agent_turn_context protect_turn_context; Type: TRIGGER; Schema: public; Owner: newhart
--

CREATE TRIGGER protect_turn_context BEFORE INSERT OR DELETE OR UPDATE ON public.agent_turn_context FOR EACH ROW EXECUTE FUNCTION public.protect_bootstrap_context_writes();
...
--
-- Name: agent_turn_context trg_agent_turn_context_updated_at; Type: TRIGGER; Schema: public; Owner: newhart
--
...
--
-- Name: agent_chat trg_enforce_agent_chat_function_use; Type: TRIGGER; Schema: public; Owner: nova
--

CREATE TRIGGER trg_enforce_agent_chat_function_use BEFORE INSERT ON public.agent_chat FOR EACH ROW EXECUTE FUNCTION public.enforce_agent_chat_function_use();


--
-- Name: agent_chat trg_enforce_function_use; Type: TRIGGER; Schema: public; Owner: nova
--

CREATE TRIGGER trg_enforce_function_use BEFORE INSERT ON public.agent_chat FOR EACH ROW EXECUTE FUNCTION public.enforce_agent_chat_function_use();
...
--
-- Name: agent_chat_from_graybeard; Type: SUBSCRIPTION; Schema: -; Owner: postgres
--
...
ALTER SUBSCRIPTION agent_chat_from_graybeard OWNER TO postgres;
...
--
-- Name: TABLE agent_turn_context; Type: ACL; Schema: public; Owner: newhart
--

GRANT SELECT ON TABLE public.agent_turn_context TO nova;
...
\unrestrict d9a34hXuR1t5oCnOOU2IFdZwvUObUqDb1z1ZPpm74NFDDKqPF14jh4wjmeKXqqx
