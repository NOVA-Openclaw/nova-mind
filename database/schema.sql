...
AS $$
BEGIN
    IF current_setting('agent_chat.bypass_gate', true) = 'on' THEN
        RETURN NEW;
    END IF;
    RAISE EXCEPTION 'Direct INSERT on agent_chat is not allowed. Use send_agent_message(sender, message, recipients) instead.';
END;
$$;
